    ...
    <div class="row">
        ...
        <div id="content" class="col-md-3 well" >
                ...
                <div class="row pull-right">
                      @if (!Auth::guest())
                        @if (Auth::user()->Tipo==1)
                      <button type="button" class="btn btn-info btn-xs glyphicon glyphicon-pencil" onclick="location.href= '/promocion/edit/{{$promo->id}}' "></button>
        ...
        @if (!Auth::guest())
            ...
            <div id="content" class="col-md-3 well" style ='background-color: #FC6363;'>
                ...
                <div class="row pull-right">
                      @if (!Auth::guest())
                        @if (Auth::user()->Tipo==1)
                      <button type="button" class="btn btn-info btn-xs glyphicon glyphicon-pencil" onclick="location.href= '/promocion/edit/{{$promo->id}}' " disabled="true"></button>
